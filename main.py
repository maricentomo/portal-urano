...
# Configurar modelo Gemini via variável de ambiente
# Use GEMINI_MODEL no Railway para especificar qual modelo usar
GEMINI_MODEL = os.environ.get("GEMINI_MODEL", "gemini-2.0-flash-thinking-exp-1219")
...
INSTRUCOES_SISTEMA = load_system_instructions()
